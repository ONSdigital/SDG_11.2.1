...
if __name__ == "__main__":
    ...
    replacements = {"2011 output area": 'OA11CD',
                    ...
                    "Day-to-day activities limited a little": "disab_ltd_little",  # noqa
    ...
    for local_auth in list_local_auth:
        ...
        eng_wales_la_pop_df = whole_nation_pop_df.merge(
            eng_wales_la_file,
            how='right',
            left_on=lad_col,
            right_on=lad_col,
        ...
        # Create a list of tuples of the start and finish indexes for the age
        # bins
        ...
        eng_wales_la_pop_df = dt.disab_disagg(
            disability_df, eng_wales_la_pop_df)
        ...
        age_servd_df = dt.served_proportions_disagg(
            pop_df=eng_wales_la_pop_df,
        ...
        sex_servd_df = dt.served_proportions_disagg(
            pop_df=eng_wales_la_pop_df,
            pop_in_poly_df=pop_in_poly_df,
            cols_lst=sex_cols)
