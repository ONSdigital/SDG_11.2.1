...
# stop times
stop_times_types = {'trip_id' : 'object', 'departure_time' : 'object', 'stop_id' : 'object'}

stop_times_df = di._csv_to_df(file_nm = 'stop_times',
                              csv_path = os.path.join(output_directory, 'stop_times.txt'),
                              dtypes = stop_times_types)

# trips
trips_types = {'route_id' : 'object', 'service_id' : 'int64', 'trip_id' : 'object'}
...
calendar_df = di._csv_to_df(file_nm = 'calendar',
                            csv_path = os.path.join(output_directory, 'calendar.txt'),
